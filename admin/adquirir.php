    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card mb-4">
                ...
                <form method="POST" id="datoHtml1" action="">
                    <div class="card-body" >
                        ...
                        <div id="status1" style="padding: 0.7em 0 0 0"></div>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success">Votos <i class="fas fa-building"></i></h6>
                </div>
                <div class="card-body">
                    <div id='donaVotos'><!-- Plotly chart will be drawn inside this DIV --></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    Plotly.newPlot('donaVotos', data, layout)
</script>
