    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <form class="row g-3" method="POST" action="" id="datoHtml">
                <div class="col-md-6">
                    <label for="inputEmail4" class="form-label">Nombres <span style="color: #00ff00">*</span></label>
                    <input type="text" class="form-control" name="nombre" id="nombre" value="<?php echo $show['nombre_scs0_rev'] ?>">
                </div>
                <div class="col-md-6">
                    <label for="inputPassword4" class="form-label">Usuario <span style="color: #00ff00">*</span></label>
                    <input type="text" class="form-control" name="usuario" id="usuario" value="<?php echo $show['user_scs0_rev'] ?>">
                </div>
                <div class="col-12">
                    <label for="inputAddress" class="form-label">Correo Electrónico <span style="color: #00ff00">*</span></label>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="vivienda" id="vivienda" value="<?php echo $show['vivienda_scs0_rev'] ?>" disabled>
                </div>
                <div class="col-12 text-center">
                    <button type="button" class="btn btn-danger col-3" data-bs-toggle="modal" data-bs-target="#staticBackdropb">
                ...
                <div class="modal fade" id="staticBackdropb" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        ...
                        <div class="modal-body">
                            ¿Desea elimiar su usuario? Esta acción no tiene reversa
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                            <button type="button" class="btn btn-success" name="eliminar" id="eliminar" data-bs-dismiss="modal">Confirmar</button>
                        </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Actualización de Datos Personales</h6>
                </div>
                <div class="card-body">
