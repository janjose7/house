            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <img class="col-lg-6 d-none d-lg-block" src="img/q223.jpg" alt="Abstractae Q2/22" style="height: 32em">
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2">Solicitud de Nuevo Código</h1>
                                        <p class="mb-4">Introduza el correo electrónico para actualizar el código de verificación.
                                        </p>
                                    </div>
                                    <form class="user" method="POST" id="datoHtml">
                                        ...
                                        <div id="status"></div>
                                        <input type="button" name="solicitar" id="solicitar" class="btn btn-success btn-user btn-block" value="Solicitar">
                                    </form>
                                    <hr>
                                    <div class="text-center">
